...
export const postReadingQuizzes = {
    ...
    questions: [
      {
        ...
        options: ['Cấp tỉnh', 'Quốc gia', 'Quốc gia đặc biệt', 'Cấp huyện'],
        optionsEn: ['Provincial', 'National', 'Special National', 'District'],
        correct: 1,
  ...
  // Vườn cò thị trấn Phước Long
  9: {
    heritageId: 9,
    heritageName: 'Vườn cò thị trấn Phước Long',
    questions: [
      {
        id: 'h9_q1',
        type: 'multiple_choice',
        question: 'Diện tích vườn cò thị trấn Phước Long là bao nhiêu?',
        questionEn: 'What is the area of Phuoc Long Stork Garden?',
      ...
      },
      {
        id: 'h9_q2',
        type: 'true_false',
        question: 'Vườn cò là nơi cư trú của nhiều loài chim như cò trắng, cò ma, việt mốc.',
        questionEn: 'The stork garden is home to many bird species such as white herons, black-winged stilts, and painted storks.',
        correct: true,
        explanation: 'Vườn cò Phước Long là nơi cư trú của nhiều loài chim quý, bao gồm cò trắng, cò ma, việt mốc, cồng cọc.',
    ...
    questions: [
      {
        id: 'h11_q1',
        type: 'true_false',
        question: 'Phủ thờ Bác Hồ nằm tại ấp Mỹ I, xã Phước Long.',
        questionEn: 'The Ho Chi Minh Shrine is located in My I hamlet, Phuoc Long commune.',
        correct: true,
        explanation: 'Phủ thờ Bác Hồ tọa lạc tại ấp Mỹ I, xã Phước Long, tỉnh Cà Mau.',
        explanationEn: 'The Ho Chi Minh Shrine is located in My I hamlet, Phuoc Long commune, Ca Mau province.',
      },
      {
        id: 'h11_q2',
        type: 'multiple_choice',
    ...
    questions: [
      {
        id: 'h12_q1',
        type: 'multiple_choice',
        question: 'Nghĩa trang Liệt sĩ xã Phước Long là nơi an nghỉ của bao nhiêu liệt sĩ?',
        questionEn: 'How many martyrs rest at Phuoc Long Martyrs Cemetery?',
        options: ['Khoảng 800', 'Khoảng 1.200', 'Khoảng 1.600', 'Khoảng 2.000'],
        optionsEn: ['About 800', 'About 1,200', 'About 1,600', 'About 2,000'],
        correct: 2,
        explanation: 'Nghĩa trang là nơi an nghỉ của khoảng 1.600 anh hùng liệt sĩ.',
        explanationEn: 'The cemetery is the resting place of about 1,600 heroic martyrs.',
      },
      {
        id: 'h12_q2',
        type: 'true_false',
        question: 'Chiến thắng Phước Long diễn ra vào ngày 6/1/1975.',
        questionEn: 'The Phuoc Long Victory took place on January 6, 1975.',
        correct: true,
        explanation: 'Chiến dịch Đường 14 - Phước Long kết thúc thắng lợi vào ngày 6/1/1975.',
        explanationEn: 'The Route 14 - Phuoc Long Campaign ended victoriously on January 6, 1975.',
      },
    ],
  },
  ...
  26: {
    ...
    questions: [
      ...
      },
      {
        ...
        correct: true,
        explanation: 'Năm 2001, Chùa Xiêm Cán được UBND tỉnh Bạc Liêu xếp hạng là di tích kiến trúc nghệ thuật cấp tỉnh.',
        explanationEn: 'In 2001, Xiem Can Pagoda was ranked as a provincial-level architectural and artistic relic by Bac Lieu Provincial People\'s Committee.',
      },
    ],
  },
  ...
  44: {
    ...
    questions: [
      ...
      },
      {
        id: 'h44_q2',
        type: 'true_false',
        question: 'Lễ hội Dạ cổ hoài lang được tổ chức vào rằm tháng 8 âm lịch.',
        questionEn: 'The Da Co Hoai Lang festival is held on the full moon of the 8th lunar month.',
        correct: true,
        explanation: 'Lễ hội Dạ cổ hoài lang truyền thống được tổ chức vào khoảng rằm tháng 8 âm lịch hàng năm.',
        explanationEn: 'The traditional Da Co Hoai Lang festival is held around the full moon of the 8th lunar month annually.',
      },
    ],
  },
