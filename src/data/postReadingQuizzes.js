    ...
    questions: [
      {
        ...
        options: ['Xã Khánh Bình Tây', 'Xã Tân Ân', 'Xã Gành Hào', 'Xã Trí Lực'],
        optionsEn: ['Khanh Binh Tay commune', 'Tan An commune', 'Ganh Hao commune', 'Tri Luc commune'],
        correct: 0,
        explanation: 'Hòn Đá Bạc thuộc xã Khánh Bình Tây, tỉnh Cà Mau.',
        explanationEn: 'Hon Da Bac is located in Khanh Binh Tay commune, Ca Mau province.',
      },
      {
        id: 'h5_q2',
        type: 'true_false',
  ...
  6: {
    ...
    questions: [
      ...
      },
      {
        id: 'h6_q2',
        type: 'true_false',
        question: 'Bến Vàm Lũng thuộc xã Tân Ân, tỉnh Cà Mau.',
        questionEn: 'Ben Vam Lung is located in Tan An commune, Ca Mau province.',
        correct: true,
        explanation: 'Bến Vàm Lũng thuộc xã Tân Ân, tỉnh Cà Mau.',
        explanationEn: 'Ben Vam Lung is located in Tan An commune, Ca Mau province.',
      },
    ],
  },
    ...
    questions: [
      {
        id: 'h11_q1',
        type: 'true_false',
        question: 'Phủ thờ Bác Hồ nổi tiếng ở Cà Mau nằm tại xã Trí Lực, tỉnh Cà Mau.',
        questionEn: 'The famous Ho Chi Minh Shrine in Ca Mau is located in Tri Luc commune, Ca Mau province.',
        correct: true,
        explanation: 'Phủ thờ Bác Hồ (ấp Phủ Thờ) là địa chỉ tưởng niệm quen thuộc tại xã Trí Lực, tỉnh Cà Mau.',
        explanationEn: 'The Ho Chi Minh Shrine (Phu Tho hamlet area) is a well-known memorial site in Tri Luc commune, Ca Mau province.',
      },
      {
        id: 'h11_q2',
        type: 'multiple_choice',
