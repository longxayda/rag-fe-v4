...
const PopularDestinations = () => {
  ...
  const destinationsData = [
    { id: 1, name: 'Mũi Cà Mau', places: '05', imageUrl: 'https://res.cloudinary.com/dybmh6wnf/image/upload/v1770215043/muicamau_hukadp.jpg' },
    ...
    { id: 4, name: 'Vườn Cò Bạc Liêu', places: '04', imageUrl: 'https://res.cloudinary.com/dybmh6wnf/image/upload/v1770215042/vuonco_c1kqei.jpg' },
